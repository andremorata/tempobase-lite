...
3. On opening the app, a running timer that started on an earlier calendar day (user's local time) prompts for recovery: stop it at the last heartbeat, keep it running, or discard the entry.
