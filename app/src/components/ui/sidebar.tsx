  ...
  return (
    <main
      ...
      className={cn(
        ...
        // width; without it, wide/unbreakable content (e.g. a long time-entry
        // description) forces the inset past the viewport and the whole page
        // scrolls horizontally instead of the content truncating.
